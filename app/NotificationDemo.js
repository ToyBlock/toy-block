...
import Notification, {DURATION} from '../components/Notification';
    ...
    render() {
        return (
            <View style={styles.container}>
                {this.getButton('LENGTH_SHORT+top', 'top', 0)}
                ...
                <Notification ref="toast" position={this.state.position}/>
                <Notification ref="toastWithStyle" style={{backgroundColor:'red'}} position={this.state.position}/>
            </View>
        );
    }
}
