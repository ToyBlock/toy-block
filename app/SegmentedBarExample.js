...
export default class SegmentedBarDemo extends Component {
  ...
  renderCustomItems() {
    ...
    return this.barCustomItems.map((item, index) => {
      ...
      let tintColor = isActive ? Theme.primary : '#989898';
      return (
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1}} stickyHeaderIndices={[1]}>
        ...
        <Carousel
          style={{backgroundColor: Theme.borderColor, height: 238, borderTopWidth: 1, borderTopColor: Theme.borderColor}}
          carousel={false}
