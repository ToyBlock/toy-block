    ...
    if (icon || icon === 0) {
      ...
      if (!React.isValidElement(icon)) {
        ...
        if (typeof icon === 'string') {
          switch (icon) {
            case 'success': imageSource = require('../../style/icons/success.png'); break;
            case 'fail': imageSource = require('../../style/icons/fail.png'); break;
            case 'smile': imageSource = require('../../style/icons/smile.png'); break;
            case 'sad': imageSource = require('../../style/icons/sad.png'); break;
            case 'info': imageSource = require('../../style/icons/info.png'); break;
            case 'stop': imageSource = require('../../style/icons/stop.png'); break;
